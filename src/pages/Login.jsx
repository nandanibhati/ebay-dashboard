  ...
  return (
    <div className="min-h-screen flex" style={{ fontFamily: "Inter, ui-sans-serif, system-ui" }}>
      ...
      >
        ...
        {/* Centre copy + signature floating panel */}
        <div className="relative z-10 grid gap-10">
          ...
          {/* signature floating stat panel — glass cards with live-feeling numbers */}
          <div className="relative anim-fade-up" style={{ animationDelay: "160ms" }}>
            <div className="grid grid-cols-3 gap-3">
              {[
                { icon: TrendingUp, label: "Revenue", value: "£2.4M", color: "#F4B400", delay: 0 },
                { icon: BarChart2, label: "Margin", value: "41.6%", color: "#2563EB", delay: 90 },
                { icon: ShoppingBag, label: "Orders", value: "1,284", color: "#22C55E", delay: 180 },
              ].map((s) => (
                <div
                  key={s.label}
                ...
                >
                  ...
                  <p className="text-white text-lg font-bold tracking-tight relative" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
                    {s.value}
                  </p>
            ...
            {/* connecting glow line under cards */}
            <div
      ...
      >
        {/* soft background accents on the form side */}
        <div
        ...
        <div className="w-full max-w-sm relative z-10 anim-fade-up" style={{ animationDelay: "60ms" }}>
          <div
            className="rounded-[28px] border border-white/70 bg-white/80 backdrop-blur-xl shadow-[0_30px_70px_-20px_rgba(30,41,59,0.25)] p-8 sm:p-9 space-y-7"
          >
            {/* Mobile logo */}
            ...
            {/* Heading */}
            <div>
              <h1 className="text-2xl font-bold text-slate-900 tracking-tight" style={{ fontFamily: "Sora, sans-serif" }}>Sign in</h1>
            ...
            <p className="text-center text-sm text-slate-400">
              ...
              <Link to="/signup" className="font-semibold transition-colors" style={{ color: "#B45F06" }}>
                Sign Up
              </Link>
            </p>
          </div>
