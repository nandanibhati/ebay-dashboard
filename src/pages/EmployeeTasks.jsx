...
export default function Tasks() {
  ...
  const updateTaskStatus = async (id, status) => {
    try {
      ...
      formData.append("assignedTo", currentTask.assignedTo);
      formData.append("assignedBy", currentTask.assignedBy);
        ...
        <div className="flex-1 px-5 lg:px-10 py-8 max-w-[1600px] mx-auto w-full flex flex-col gap-6">
          ...
          >
            <GlassPanel hover={false} className="p-6 sm:p-8 overflow-hidden relative">
              ...
              <div className="relative z-10">
                <p
                  className="text-[11px] font-semibold tracking-[0.14em] uppercase mb-2 flex items-center gap-1.5"
                  style={{ color: "#F4B400" }}
                >
                ...
                <div className="flex items-center gap-3">
                  <div
                    className="w-11 h-11 rounded-2xl flex items-center justify-center text-[#0F172A] shadow-[0_10px_24px_-6px_rgba(244,180,0,0.4)]"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              {
                label: "Closed Nodes",
                value: `${completedTasks} Resolved`,
                icon: CheckCircle2,
                color: "#22C55E",
              },
              {
                label: "Mean Process Ratio",
                value: `${averageProgress}% Index`,
                icon: BarChart3,
                color: "#F4B400",
              },
            ].map((stat, i) => (
          ...
          >
            <GlassPanel hover={false} className="p-5 sm:p-6 flex flex-col gap-5">
              <div className="flex items-center gap-3 pb-3 border-b border-slate-900/[0.06]">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-slate-800" style={{ fontFamily: "Sora, sans-serif" }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                ...
                <div className="md:col-span-2 lg:col-span-3 xl:col-span-4">
                  ...
                  <textarea
                    placeholder="Describe the task, milestones, and requirements..."
                ...
                <div>
                  <label className={labelCls}>Screenshot / Proof</label>
                  <input
                    type="file"
                    accept="image/*"
                    className={inputCls}
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-end pt-2 border-t border-slate-900/[0.06]">
                {editingId && (
                  <button
                    type="button"
                    onClick={() => {
          ...
          >
            <GlassPanel hover={false} className="overflow-hidden w-full flex flex-col">
              ...
              {tasks.length === 0 && (
                <div className="text-center py-16 px-6 text-slate-400 font-medium">
                  <div className="flex flex-col items-center gap-2 justify-center">
                    ...
                    <span>No tasks found for this workspace yet.</span>
                  </div>
                </div>
              )}
              ...
              {tasks.length > 0 && (
                <div className="md:hidden divide-y divide-slate-900/[0.06]">
                    ...
                    {tasks.map((task) => (
                      ...
                      >
                        ...
                        <div className="flex flex-wrap items-center gap-2 text-xs">
                          ...
                          <span className="inline-flex items-center gap-1.5 px-2 py-1 rounded-lg bg-blue-50 border border-blue-100 text-blue-700 font-semibold">
                            <UserCheck size={12} />
                            {task.assignedBy || "-"}
                          </span>
                          ...
                          <div className="flex items-center gap-2 shrink-0">
                            ...
                            {task.assignedBy === localStorage.getItem("employeeName") && (
                              <button
                                ...
                                className="flex items-center justify-center p-2 text-red-500 bg-red-50 border border-red-100 rounded-lg hover:bg-red-100 hover:text-red-700 transition-all active:scale-95 shadow-sm"
                                title="Delete Task"
                              >
                  ...
                  <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="divide-y divide-slate-900/[0.06] text-sm text-slate-700">
                      {tasks.map((task) => (
                        <tr
                          key={task._id}
                          className="hover:bg-[#F4B400]/[0.06] transition-colors duration-150 group"
                        >
